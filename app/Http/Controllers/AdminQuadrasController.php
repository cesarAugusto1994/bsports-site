<?php namespace App\Http\Controllers;
	...
	class AdminQuadrasController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Ativo','name'=>'ativo','type'=>'checkbox','validation'=>'min:1|max:255','width'=>'col-sm-10','dataenum'=>'1;2'];
