<?php namespace App\Http\Controllers;
	...
	class AdminUsers12Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Pessoa Id","name"=>"pessoa_id","join"=>"pessoas,id"];
			$this->col[] = ["label"=>"Token","name"=>"token"];
			$this->col[] = ["label"=>"Ignore Tour","name"=>"ignore_tour"];
			...
			$this->form[] = ['label'=>'Pessoa Id','name'=>'pessoa_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'pessoa,id','datatable_ajax'=>'true'];
			$this->form[] = ['label'=>'Token','name'=>'token','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Ignore Tour','name'=>'ignore_tour','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Ignore Tour","name"=>"ignore_tour","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
